...
//    public static final String CERT_FILE_NAME = "upm.cer";
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.restore:
                ...
                // BEFORE: File restoreFile = new File(Environment.getExternalStorageDirectory(), Utilities.DEFAULT_DATABASE_FILE);
                File restoreFile = new File("/mnt/extsd/", Utilities.DEFAULT_DATABASE_FILE);
    ...
    protected Dialog onCreateDialog(int id) {
        ...
        // OLD: File backupFile = new File(Environment.getExternalStorageDirectory(), Utilities.DEFAULT_DATABASE_FILE);
        // NEW: "/mnt/extsd/"

        case CONFIRM_OVERWRITE_BACKUP_FILE:
            File backupFile = new File("/mnt/extsd/", Utilities.DEFAULT_DATABASE_FILE);
  ...
  // NEED TO FIGUE THIS ONE OUT
    ...
    // Original - File fileOnSDCard = new File(Environment.getExternalStorageDirectory(), Utilities.DEFAULT_DATABASE_FILE);
    // New - getExternalStorageState(File path)

    private void backupDatabase() {
        File fileOnSDCard = new File("/mnt/extsd/", Utilities.DEFAULT_DATABASE_FILE);
